...
class CpuWaitResetMultistepCollector(DecorrelatingStartCollector):
    """Collector which executes ``agent.step()`` in the sampling loop.
    ...
    This collector updates multiple observation buffers, and can be used with
    multistep prediction architectures. 
    """
