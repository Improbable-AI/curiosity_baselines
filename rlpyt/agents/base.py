...
IcmAgentCuriosityInputs = namedarraytuple("IcmAgentCuriosityInputs", ["observation", "action", "next_observation"])
NdigoAgentCuriosityInputs = namedarraytuple("NdigoAgentCuriosityInputs", ["observation", "prev_actions", "actions"])
